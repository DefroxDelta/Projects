...
public class Withdrawl extends JFrame implements ActionListener {
    JButton amount1,withdrawl,cancel;
    JTextField amount;
    String Pnum;

    Withdrawl(String Pnum) {
        ...
        withdrawl.setBounds(400,490,100,20);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() ==withdrawl){
            ...
            if(number.equals("")){
                ...
                try{
                    Conn conn = new Conn();
                    String query1 ="insert into bank values('"+Pnum+"','"+date+"','Withdraw','"+number+"')";
                    conn.s.executeUpdate(query1);
                    JOptionPane.showMessageDialog(null,"Rs "+number+" Cash withdrew successfully." );
                    setVisible(false);
